      ...
      if (num_attrs > 0)
        {
          ...
          for (size_t i=0; i<numitems_vector.size(); i++)
            {
              printf("pack: numitems_vector[%u] = %u\n", i, numitems_vector[i]);
            }
