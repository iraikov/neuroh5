...
namespace neuroh5
{
  ...
  namespace cell
  {
    ...
    (
     ...
     CellIndexingType indexing_type = IndexCreate,
     ...
     )
    {
      ...
      global_index_size=ptr_start; global_attr_size=attr_start; global_sec_size=sec_start; global_topo_size=topo_start;
      for (size_t i=0; i<size; i++)
        {
     ...
     )
    {
      ...
      switch (cell_indexing)
        ...
        case IndexCreate:
          ...
          break;
        case IndexLink:
          // TODO: validate and link cell index
          break;
        case IndexNone:
          break;
        }
