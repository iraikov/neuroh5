...
cat data/dentate_test.0.[0-9]*.edges | sort -s -k 2n,1n > data/dentate_test.0.test.edges
cat data/dentate_test.1.[0-9]*.edges | sort -s -k 2n,1n > data/dentate_test.1.test.edges

## Remove first column from validation data file
cut -d' ' -f2- data/dentate_test.h5.0.edges > data/dentate_test.0.base.edges
cut -d' ' -f2- data/dentate_test.h5.1.edges > data/dentate_test.1.base.edges
