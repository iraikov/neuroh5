...
if rank == 0:
    print read_population_ranges(MPI._addressof(comm), "data/dentate_Sampled_Soma_Locations.h5")
...
g = NeuroH5CellAttrGen(MPI._addressof(comm), "data/dentate_Sampled_Soma_Locations.h5", "MOPP", io_size=comm.size, namespace='Coordinates')
