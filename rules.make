...
ifndef PARMETIS
DRIVER_OBJ       	:= $(filter-out build/driver/parts.o,$(DRIVER_OBJ))
endif
DRIVER_INCLUDES  	:= $(addprefix -I,$(INC_DIR) include $(HDF5_INCDIR) $(MPI_INCDIR) $(PARMETIS_INCDIR))

MODULES   	:= graph mpi io io/hdf5 model
...
ifdef PARMETIS
build/parts: build/driver/parts.o build/libngh5.graph.a build/libngh5.io.a build/libngh5.io.hdf5.a build/libngh5.mpi.a
